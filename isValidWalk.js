...
function isValidWalk(walk) {
    ...
    let n = walk.filter(e => e === 'n');
    let s = walk.filter(e => e === 's');
    let w = walk.filter(e => e === 'w');
    let e = walk.filter(e => e === 'e');
...
console.log('isValidWalk', isValidWalk(['n','s','n','s','n','s','n','s','n','s'])); // should be true
